...
class CLM(LM):
    ...
    def load_model(self):
        ...
        # Llama-2 requires a Hugging Face token accepted for the gated model.
        hf_auth = os.getenv("HUGGING_FACE_HUB_TOKEN")
        if not hf_auth:
            raise RuntimeError("Set HUGGING_FACE_HUB_TOKEN before loading this model.")
