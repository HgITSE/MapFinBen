...
TASK_REGISTRY = {
    ...
    # 单选选择
    "mapfin_AS":mapfin.MapFinAS,
    "mapfin_SA":mapfin.MapFinSA,
    "mapfin_TC":mapfin.MapFinTC,

    # 文本摘要
    "mapfin_TS":mapfin.MapFinTS,

    # 自动问答
    "mapfin_QA":mapfin.MapFinQA,
}
...
def get_task_dict(task_name_list: List[Union[str, financial_evaluation.lm_eval.base.Task]]):
    task_name_dict = {
